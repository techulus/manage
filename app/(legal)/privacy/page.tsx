		...
		<div className="h-full dark:text-gray-100">
			...
			<div className="relative isolate px-6 pt-14 lg:px-8">
				...
				<div className="mx-auto max-w-2xl py-32">
					...
					<p className="mt-3">
						At managee.xyz, accessible from https://managee.xyz/, one of our
						main priorities is the privacy of our visitors. This Privacy Policy
						document contains types of information that is collected and
						recorded by managee.xyz and how we use it.
					</p>
					...
					<p className="mt-3">
						...
						that they shared and/or collect in managee.xyz. This policy is not
					...
					<p className="mt-3">
						managee.xyz follows a standard procedure of using log files. These
					...
					<p className="mt-3">
						Like any other website, managee.xyz uses &apos;cookies&apos;. These
					...
					<p className="mt-3">
						...
						advertising partners of managee.xyz.
					</p>

					<p className="mt-3">
						Third-party ad servers or ad networks uses technologies like
						cookies, JavaScript, or Web Beacons that are used in their
						respective advertisements and links that appear on managee.xyz,
					...
					<p className="mt-3">
						Note that managee.xyz has no access to or control over these cookies
					...
					<p className="mt-3">
						managee.xyz&apos;s Privacy Policy does not apply to other
					...
					<p className="mt-3">
						managee.xyz does not knowingly collect any Personal Identifiable
