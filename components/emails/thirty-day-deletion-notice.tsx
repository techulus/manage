      ...
      <Body style={main}>
        <Container style={container}>
          <Section style={header}>
            <Heading style={h1}>
              {isOrganization ? 'Organization Deletion Notice' : 'Account Deletion Notice'}
            </Heading>
          </Section>
          ...
          <Section style={content}>
            ...
            <Text style={text}>
              ...
              </strong> unless you log in and use the platform.
            </Text>
            ...
            <Section style={buttonContainer}>
              <Button style={button} href="https://managee.xyz/start">
                {isOrganization ? 'Keep My Organization Active' : 'Keep My Account Active'}
              </Button>
            </Section>
