      ...
      <Body style={main}>
        <Container style={container}>
          <Section style={header}>
            <Heading style={h1}>
              🚨 Final Warning: {isOrganization ? 'Organization' : 'Account'} Deletion in 7 Days
            </Heading>
          </Section>
          ...
          <Section style={content}>
            ...
            <Text style={text}>
              {isOrganization ? (
                <>
                  • Your organization will be permanently deleted<br />
                  • All projects and tasks will be lost<br />
                  • This action cannot be undone
                </>
              ) : (
                <>
                  • Your account will be permanently deleted<br />
                  • All your projects and tasks will be lost<br />
                  • This action cannot be undone
                </>
              )}
            </Text>
            ...
            <Text style={text}>
              <strong>
                {isOrganization ? 'To save your organization:' : 'To save your account:'}
              </strong> Simply log in to Manage within the next 7 days.
            </Text>
            
            <Section style={buttonContainer}>
              <Button style={urgentButton} href="https://managee.xyz/start">
                {isOrganization ? 'Save My Organization Now' : 'Save My Account Now'}
              </Button>
            </Section>
